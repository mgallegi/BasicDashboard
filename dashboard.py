...
def creat_bar_chart(ingredients=["alcohol","malic_acid","ash"]):
    bar_fig = px.bar(avg_wine_df, x="WineType",y=ingredients, title="Average Ingredients per Wine Types")
...
app.layout = html.Div(
    children=[
        ...
        html.H1("Wine Analysis Dataset", style={"text-aling":"center"}),
        html.Div("Explore Relationship between various Ingredientes used in creation of three types of Wines",style={"text-aling":"center"}),
        html.Br(),
        ...
        html.Div(children=[
            ...
            dcc.Graph(id="bar_chart", figure=creat_bar_chart())
...
def update_bar_chart(ingredients):
    return creat_bar_chart(ingredients)    
